...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Concierge.site_skin'
        db.alter_column('concierges_concierge', 'site_skin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.SiteSkin']))


    def backwards(self, orm):
        
        # Changing field 'Concierge.site_skin'
        db.alter_column('concierges_concierge', 'site_skin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.SiteSkin'], null=True))
    ...
    models = {
        ...
        'concierges.concierge': {
            ...
            'site_skin': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['localsite.SiteSkin']"})
        },
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'54310f1b6a8130fe588d922b923ec90b'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
