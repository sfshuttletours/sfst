...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Concierge'
        db.create_table('concierges_concierge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='concierges', to=orm['contact.Contact'])),
            ('image', self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(max_length=128, auto_rename=True, blank=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, db_index=True)),
            ('email_notifications', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('send_checks_to', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('booking_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('per_week', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('hotel_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('concierges', ['Concierge'])

        # Adding M2M table for field orders on 'Concierge'
        db.create_table('concierges_concierge_orders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('concierge', models.ForeignKey(orm['concierges.concierge'], null=False)),
            ('order', models.ForeignKey(orm['shop.order'], null=False))
        ))
        db.create_unique('concierges_concierge_orders', ['concierge_id', 'order_id'])

        # Adding model 'ConciergeCommission'
        db.create_table('concierges_conciergecommission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concierge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commissions', to=orm['concierges.Concierge'])),
        ...
        db.send_create_signal('concierges', ['ConciergeCommission'])

        # Adding unique constraint on 'ConciergeCommission', fields ['concierge', 'tour_type']
        db.create_unique('concierges_conciergecommission', ['concierge_id', 'tour_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ConciergeCommission', fields ['concierge', 'tour_type']
        db.delete_unique('concierges_conciergecommission', ['concierge_id', 'tour_type_id'])

        # Deleting model 'Concierge'
        db.delete_table('concierges_concierge')

        # Removing M2M table for field orders on 'Concierge'
        db.delete_table('concierges_concierge_orders')

        # Deleting model 'ConciergeCommission'
        db.delete_table('concierges_conciergecommission')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'f451cde921141f8349f5828b225206d3'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
