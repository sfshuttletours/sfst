...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TourCategory'
        db.create_table('localsite_tourcategory', (
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('localsite', ['TourCategory'])

        # Adding M2M table for field categories on 'TourType'
        db.create_table('localsite_tourtype_categories', (
        ...
        db.create_unique('localsite_tourtype_categories', ['tourtype_id', 'tourcategory_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'TourCategory'
        db.delete_table('localsite_tourcategory')

        # Removing M2M table for field categories on 'TourType'
        db.delete_table('localsite_tourtype_categories')
    ...
    models = {
        ...
        'localsite.tourtype': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['localsite.TourCategory']", 'null': 'True', 'blank': 'True'}),
            ...
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True', 'blank': 'True'}),
