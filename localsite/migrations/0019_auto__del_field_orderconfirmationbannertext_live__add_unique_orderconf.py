...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'OrderConfirmationBannerText', fields ['live']
        # db.delete_unique('localsite_orderconfirmationbannertext', ['live'])   # REMOVED BY HAND - Dec. 3, 2010 - Sumit

        # Deleting field 'OrderConfirmationBannerText.live'
        db.delete_column('localsite_orderconfirmationbannertext', 'live')

        # Adding unique constraint on 'OrderConfirmationBannerText', fields ['site_skin']
        db.create_unique('localsite_orderconfirmationbannertext', ['site_skin_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OrderConfirmationBannerText', fields ['site_skin']
        db.delete_unique('localsite_orderconfirmationbannertext', ['site_skin_id'])

        # Adding field 'OrderConfirmationBannerText.live'
        db.add_column('localsite_orderconfirmationbannertext', 'live', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)

        # Adding unique constraint on 'OrderConfirmationBannerText', fields ['live']
        db.create_unique('localsite_orderconfirmationbannertext', ['live'])
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'8716fed6cdc4991f2e90d51ce5cfd1c0'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
