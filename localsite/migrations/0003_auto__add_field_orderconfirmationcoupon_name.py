...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderConfirmationCoupon.name'
        db.add_column('localsite_orderconfirmationcoupon', 'name', self.gf('django.db.models.fields.CharField')(default='Coupon Name', max_length=255), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OrderConfirmationCoupon.name'
        db.delete_column('localsite_orderconfirmationcoupon', 'name')
