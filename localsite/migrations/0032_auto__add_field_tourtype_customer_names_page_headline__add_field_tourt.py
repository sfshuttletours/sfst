...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.customer_names_page_headline'
        db.add_column('localsite_tourtype', 'customer_names_page_headline', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'TourType.customer_names_page_explanation'
        db.add_column('localsite_tourtype', 'customer_names_page_explanation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'SiteSkin.customer_names_page_headline'
        db.delete_column('localsite_siteskin', 'customer_names_page_headline')

        # Deleting field 'SiteSkin.customer_names_page_explanation'
        db.delete_column('localsite_siteskin', 'customer_names_page_explanation')


    def backwards(self, orm):
        
        # Deleting field 'TourType.customer_names_page_headline'
        db.delete_column('localsite_tourtype', 'customer_names_page_headline')

        # Deleting field 'TourType.customer_names_page_explanation'
        db.delete_column('localsite_tourtype', 'customer_names_page_explanation')

        # Adding field 'SiteSkin.customer_names_page_headline'
        db.add_column('localsite_siteskin', 'customer_names_page_headline', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'SiteSkin.customer_names_page_explanation'
        db.add_column('localsite_siteskin', 'customer_names_page_explanation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    models = {
        ...
        'localsite.cartguest': {
            ...
            'cart_item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.CartItem']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'e4853a958cfb82c2135a6a0167a89bd8'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
