...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'f7f329144c7e29f7a27f1d953b2884e3'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'3af5fa5d3ab6fe5e4bc31b943f01dceb'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
