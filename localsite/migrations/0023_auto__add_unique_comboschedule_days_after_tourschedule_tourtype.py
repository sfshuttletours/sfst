...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ComboSchedule', fields ['days_after', 'tourschedule', 'tourtype']
        db.create_unique('localsite_comboschedule', ['days_after', 'tourschedule_id', 'tourtype_id'])
        
        # Removing unique constraint from the old m2m table
        db.delete_unique('localsite_comboschedule', ['tourschedule_id', 'tourtype_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ComboSchedule', fields ['days_after', 'tourschedule', 'tourtype']
        db.delete_unique('localsite_comboschedule', ['days_after', 'tourschedule_id', 'tourtype_id'])

        # Creating unique constraint from the old m2m table
        db.create_unique('localsite_comboschedule', ['tourschedule_id', 'tourtype_id'])
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'beed0b9930c9886b4cc3add44df0951a'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
