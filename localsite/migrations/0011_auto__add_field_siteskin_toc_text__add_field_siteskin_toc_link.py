...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSkin.toc_text'
        db.add_column('localsite_siteskin', 'toc_text', self.gf('django.db.models.fields.CharField')(default='I agree to 50% refund with 2 hours written notice, and no refunds for less than 2 hours notice, and no refunds on Alcatraz-related tours, and other general terms', max_length=512), keep_default=False)

        # Adding field 'SiteSkin.toc_link'
        db.add_column('localsite_siteskin', 'toc_link', self.gf('django.db.models.fields.URLField')(default='http://www.sanfranshuttletours.com/terms_privacy.htm', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSkin.toc_text'
        db.delete_column('localsite_siteskin', 'toc_text')

        # Deleting field 'SiteSkin.toc_link'
        db.delete_column('localsite_siteskin', 'toc_link')
