...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSkin.concierge_reg_ui_banner'
        db.add_column('localsite_siteskin', 'concierge_reg_ui_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSkin.concierge_reg_ui_banner'
        db.delete_column('localsite_siteskin', 'concierge_reg_ui_banner')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'c70e3f2fa8eb80186ba8027fcf388446'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
