...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSkin.favicon'
        db.add_column('localsite_siteskin', 'favicon', self.gf('django.db.models.fields.files.FileField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSkin.favicon'
        db.delete_column('localsite_siteskin', 'favicon')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'a198395e78bccce87b68cfe78b5f7b24'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
