...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourCategory.order'
        db.add_column('localsite_tourcategory', 'order', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TourCategory.order'
        db.delete_column('localsite_tourcategory', 'order')
