...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderHash.void_failed'
        db.add_column('localsite_orderhash', 'void_failed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('localsite_orderitemvoidattempt', (
            ...
            ('void_failed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('localsite', ['OrderItemVoidAttempt'])

        # Deleting field 'OrderHash.void_failed'
        db.delete_column('localsite_orderhash', 'void_failed')
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'03513cba84f7668e0fb763bf6a6f4e27'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'e4c36021ea27c3e6117b0dcdd23638fd'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
