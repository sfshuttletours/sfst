...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'5d040efb53b899614d8a12726720f06b'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'})
        },
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'dbb8e60cb5d84b205fccf1beba3f1fd5'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
