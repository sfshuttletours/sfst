...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TourType.followup_email_from'
        db.alter_column('localsite_tourtype', 'followup_email_from', self.gf('django.db.models.fields.CharField')(max_length=254))


    def backwards(self, orm):
        
        # Changing field 'TourType.followup_email_from'
        db.alter_column('localsite_tourtype', 'followup_email_from', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'8ea6d5b4472068529bc8b9d3231f9799'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'a38962e0bc878cefd8cfb9f97b93ce5e'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
