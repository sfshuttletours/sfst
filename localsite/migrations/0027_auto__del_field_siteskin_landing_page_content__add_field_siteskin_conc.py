...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SiteSkin.landing_page_content'
        db.delete_column('localsite_siteskin', 'landing_page_content')

        # Adding field 'SiteSkin.concierge_lp_content'
        db.add_column('localsite_siteskin', 'concierge_lp_content', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SiteSkin.landing_page_content'
        db.add_column('localsite_siteskin', 'landing_page_content', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'SiteSkin.concierge_lp_content'
        db.delete_column('localsite_siteskin', 'concierge_lp_content')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'e84a1f54bbf6281b19865cab1e60c459'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
