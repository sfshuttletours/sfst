...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.min_calendar_start_date'
        db.add_column('localsite_tourtype', 'min_calendar_start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'TourType.max_calendar_end_date'
        db.add_column('localsite_tourtype', 'max_calendar_end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TourType.min_calendar_start_date'
        db.delete_column('localsite_tourtype', 'min_calendar_start_date')

        # Deleting field 'TourType.max_calendar_end_date'
        db.delete_column('localsite_tourtype', 'max_calendar_end_date')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'52bd532ddc808cf41c35f3c85ce56744'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
