...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderConfirmationBannerText.header_top_text'
        db.add_column('localsite_orderconfirmationbannertext', 'header_top_text', self.gf('django.db.models.fields.TextField')(default='25% REFUND FOR ALL MISSED TOURS'), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OrderConfirmationBannerText.header_top_text'
        db.delete_column('localsite_orderconfirmationbannertext', 'header_top_text')
