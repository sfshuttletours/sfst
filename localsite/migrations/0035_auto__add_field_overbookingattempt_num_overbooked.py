...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OverbookingAttempt.num_overbooked'
        db.add_column('localsite_overbookingattempt', 'num_overbooked', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OverbookingAttempt.num_overbooked'
        db.delete_column('localsite_overbookingattempt', 'num_overbooked')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'f7167a808892d8685cb1ef6adbacfe87'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
