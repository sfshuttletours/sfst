...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderItemStatus'
        db.create_table('localsite_orderitemstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.OrderItem'], unique=True)),
        ))
        db.send_create_signal('localsite', ['OrderItemStatus'])

        # Adding model 'OrderHash'
        db.create_table('localsite_orderhash', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Order'], unique=True)),
            ('hash', self.gf('common.db_fields.RandomHashField')(default='62e1151690b10a480b724b8d8abb1f93', unique=True, max_length=128, db_index=True)),
        ))
        db.send_create_signal('localsite', ['OrderHash'])

        # Adding field 'TourProduct.allow_refunds'
        db.add_column('localsite_tourproduct', 'allow_refunds', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OrderItemStatus'
        db.delete_table('localsite_orderitemstatus')

        # Deleting model 'OrderHash'
        db.delete_table('localsite_orderhash')

        # Deleting field 'TourProduct.allow_refunds'
        db.delete_column('localsite_tourproduct', 'allow_refunds')
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'62e1151690b10a480b724b8d8abb1f93'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'})
        },
        'localsite.orderitemstatus': {
            'Meta': {'object_name': 'OrderItemStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.OrderItem']", 'unique': 'True'})
        },
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'78b4b3f6fb688afab00c801894448fd4'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
