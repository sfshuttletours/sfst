...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.price_raise_num_days'
        db.add_column('localsite_tourtype', 'price_raise_num_days', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TourType.price_raise_rate'
        db.add_column('localsite_tourtype', 'price_raise_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TourType.price_raise_num_days'
        db.delete_column('localsite_tourtype', 'price_raise_num_days')

        # Deleting field 'TourType.price_raise_rate'
        db.delete_column('localsite_tourtype', 'price_raise_rate')
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'4c1b658787cbb048d5c246b5a2ef56fc'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.priortoemailsent': {
            'Meta': {'object_name': 'PriorToEmailSent'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'})
        },
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'40c82c1433edcdd5a72afbffdd855cf6'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
        ...
        'localsite.tourtype': {
            ...
            'followup_email_from': ('django.db.models.fields.CharField', [], {'default': "'info-dev@sfshuttletours.com'", 'max_length': '254'}),
            ...
            'price_raise_num_days': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'price_raise_rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '2', 'blank': 'True'}),
