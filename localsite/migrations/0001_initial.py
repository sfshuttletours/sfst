...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localsite_dayofweek', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16)),
            ('isoweekday', self.gf('django.db.models.fields.IntegerField')(unique=True, db_index=True)),
        ))
        db.send_create_signal('localsite', ['DayOfWeek'])

        # Adding model 'TourType'
        db.create_table('localsite_tourtype', (
            ('has_brochures', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('seats_available', self.gf('django.db.models.fields.IntegerField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=128, blank=True)),
            ('option_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['product.OptionGroup'], null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(db_index=True, unique=True, max_length=128, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('rollover_on', self.gf('django.db.models.fields.files.ImageField')(max_length=128, blank=True)),
            ('is_combo', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('default_commission', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=5, decimal_places=2)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('rollover_off', self.gf('django.db.models.fields.files.ImageField')(max_length=128, blank=True)),
            ('base_price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('localsite', ['TourType'])

        # Adding M2M table for field combo_schedules on 'TourType'
        db.create_table('localsite_tourtype_combo_schedules', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tourtype', models.ForeignKey(orm['localsite.tourtype'], null=False)),
            ('tourschedule', models.ForeignKey(orm['localsite.tourschedule'], null=False))
        ))
        db.create_unique('localsite_tourtype_combo_schedules', ['tourtype_id', 'tourschedule_id'])

        # Adding model 'TourSchedule'
        db.create_table('localsite_tourschedule', (
            ('tour_time', self.gf('django.db.models.fields.TimeField')()),
            ('tour_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedules', to=orm['localsite.TourType'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('localsite', ['TourSchedule'])

        # Adding M2M table for field day_of_week on 'TourSchedule'
        db.create_table('localsite_tourschedule_day_of_week', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tourschedule', models.ForeignKey(orm['localsite.tourschedule'], null=False)),
            ('dayofweek', models.ForeignKey(orm['localsite.dayofweek'], null=False))
        ))
        db.create_unique('localsite_tourschedule_day_of_week', ['tourschedule_id', 'dayofweek_id'])

        # Adding model 'TourCapacity'
        db.create_table('localsite_tourcapacity', (
            ('seats_available', self.gf('django.db.models.fields.IntegerField')()),
            ('tour_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='capacities', to=orm['localsite.TourType'])),
        ...
        db.send_create_signal('localsite', ['TourCapacity'])

        # Adding M2M table for field day_of_week on 'TourCapacity'
        db.create_table('localsite_tourcapacity_day_of_week', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tourcapacity', models.ForeignKey(orm['localsite.tourcapacity'], null=False)),
            ('dayofweek', models.ForeignKey(orm['localsite.dayofweek'], null=False))
        ))
        db.create_unique('localsite_tourcapacity_day_of_week', ['tourcapacity_id', 'dayofweek_id'])

        # Adding model 'TourProduct'
        db.create_table('localsite_tourproduct', (
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['product.Product'], unique=True, primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.TourSchedule'], null=True, blank=True)),
            ('tour_time', self.gf('django.db.models.fields.TimeField')()),
            ('tour_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.TourType'])),
            ('overbooking_attempts', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('localsite', ['TourProduct'])

        # Adding unique constraint on 'TourProduct', fields ['tour_type', 'day', 'tour_time']
        db.create_unique('localsite_tourproduct', ['tour_type_id', 'day', 'tour_time'])

        # Adding model 'TeamMember'
        db.create_table('localsite_teammember', (
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('satchmo_utils.thumbnail.field.ImageWithThumbnailField')(max_length=128, auto_rename=True)),
            ('job_title', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('localsite', ['TeamMember'])

        # Adding model 'SurveyEmailSent'
        db.create_table('localsite_surveyemailsent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Order'], unique=True)),
        ))
        db.send_create_signal('localsite', ['SurveyEmailSent'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'DayOfWeek'
        db.delete_table('localsite_dayofweek')

        # Deleting model 'TourType'
        db.delete_table('localsite_tourtype')

        # Removing M2M table for field combo_schedules on 'TourType'
        db.delete_table('localsite_tourtype_combo_schedules')

        # Deleting model 'TourSchedule'
        db.delete_table('localsite_tourschedule')

        # Removing M2M table for field day_of_week on 'TourSchedule'
        db.delete_table('localsite_tourschedule_day_of_week')

        # Deleting model 'TourCapacity'
        db.delete_table('localsite_tourcapacity')

        # Removing M2M table for field day_of_week on 'TourCapacity'
        db.delete_table('localsite_tourcapacity_day_of_week')

        # Deleting model 'TourProduct'
        db.delete_table('localsite_tourproduct')

        # Removing unique constraint on 'TourProduct', fields ['tour_type', 'day', 'tour_time']
        db.delete_unique('localsite_tourproduct', ['tour_type_id', 'day', 'tour_time'])

        # Deleting model 'TeamMember'
        db.delete_table('localsite_teammember')

        # Deleting model 'SurveyEmailSent'
        db.delete_table('localsite_surveyemailsent')
    ...
    models = {
        ...
        'localsite.tourtype': {
            ...
            'has_brochures': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '128', 'blank': 'True'}),
            'is_combo': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True', 'blank': 'True'}),
