...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.default_site_skin'
        db.add_column('localsite_tourtype', 'default_site_skin', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['localsite.SiteSkin']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TourType.default_site_skin'
        db.delete_column('localsite_tourtype', 'default_site_skin_id')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'857aabe4795259e809868dc9ca91f104'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
