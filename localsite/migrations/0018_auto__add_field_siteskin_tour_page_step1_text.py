...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSkin.tour_page_step1_text'
        db.add_column('localsite_siteskin', 'tour_page_step1_text', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSkin.tour_page_step1_text'
        db.delete_column('localsite_siteskin', 'tour_page_step1_text')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'1ee2ceb6e84a1d22e3a098c279b21115'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
