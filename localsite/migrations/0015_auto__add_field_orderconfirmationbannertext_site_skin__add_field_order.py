...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderConfirmationBannerText.site_skin'
        db.add_column('localsite_orderconfirmationbannertext', 'site_skin', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['localsite.SiteSkin']), keep_default=False)

        # Adding field 'OrderConfirmationCoupon.site_skin'
        db.add_column('localsite_orderconfirmationcoupon', 'site_skin', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['localsite.SiteSkin']), keep_default=False)

        # Adding field 'OrderConfirmationSection.site_skin'
        db.add_column('localsite_orderconfirmationsection', 'site_skin', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['localsite.SiteSkin']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderConfirmationBannerText.site_skin'
        db.delete_column('localsite_orderconfirmationbannertext', 'site_skin_id')

        # Deleting field 'OrderConfirmationCoupon.site_skin'
        db.delete_column('localsite_orderconfirmationcoupon', 'site_skin_id')

        # Deleting field 'OrderConfirmationSection.site_skin'
        db.delete_column('localsite_orderconfirmationsection', 'site_skin_id')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'57e59dd464af6870114da3cffcdc84c4'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
