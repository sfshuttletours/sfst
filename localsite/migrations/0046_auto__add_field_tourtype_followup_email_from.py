...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.followup_email_from'
        db.add_column('localsite_tourtype', 'followup_email_from', self.gf('django.db.models.fields.TextField')(default=settings.DEFAULT_FROM_EMAIL), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'TourType.followup_email_from'
        db.delete_column('localsite_tourtype', 'followup_email_from')
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'e4d21e8646e3d287bc773e354cf24d77'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'1e0482c93d185b8211b060541a5ad6a0'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
        ...
        'localsite.tourtype': {
            ...
            'followup_email_from': ('django.db.models.fields.TextField', [], {'default': "'info-dev@sfshuttletours.com'"}),
