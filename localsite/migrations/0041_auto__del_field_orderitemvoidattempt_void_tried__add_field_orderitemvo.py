...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderItemVoidAttempt.void_tried'
        db.delete_column('localsite_orderitemvoidattempt', 'void_tried')

        # Adding field 'OrderItemVoidAttempt.void_failed'
        db.add_column('localsite_orderitemvoidattempt', 'void_failed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'OrderItemVoidAttempt.void_tried'
        db.add_column('localsite_orderitemvoidattempt', 'void_tried', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'OrderItemVoidAttempt.void_failed'
        db.delete_column('localsite_orderitemvoidattempt', 'void_failed')
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'33c993a8b8fa610471c6d423fc29e373'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'})
        },
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'bec437f9422658aa024642e975f04a33'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
