...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TourType.prior_to_tour_email_hours'
        db.alter_column('localsite_tourtype', 'prior_to_tour_email_hours', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'TourType.prior_to_tour_email_hours'
        db.alter_column('localsite_tourtype', 'prior_to_tour_email_hours', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'7cc9df55c647edf8383a2f5ee3ab81d9'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'9924e0997a92e5887405c96b0a3971ee'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
        ...
        'localsite.tourtype': {
            ...
            'prior_to_tour_email_hours': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
