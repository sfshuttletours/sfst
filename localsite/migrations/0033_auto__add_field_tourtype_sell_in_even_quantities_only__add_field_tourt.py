...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.sell_in_even_quantities_only'
        db.add_column('localsite_tourtype', 'sell_in_even_quantities_only', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TourType.is_tour_available_to_concierges'
        db.add_column('localsite_tourtype', 'is_tour_available_to_concierges', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'TourType.is_tour_available_to_resellers'
        db.add_column('localsite_tourtype', 'is_tour_available_to_resellers', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TourType.sell_in_even_quantities_only'
        db.delete_column('localsite_tourtype', 'sell_in_even_quantities_only')

        # Deleting field 'TourType.is_tour_available_to_concierges'
        db.delete_column('localsite_tourtype', 'is_tour_available_to_concierges')

        # Deleting field 'TourType.is_tour_available_to_resellers'
        db.delete_column('localsite_tourtype', 'is_tour_available_to_resellers')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'f323781bfb87468bad7d5c5dc10a2319'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
