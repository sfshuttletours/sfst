...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderItemVoidAttempt'
        db.create_table('localsite_orderitemvoidattempt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.OrderItem'], unique=True)),
            ('void_tried', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('localsite', ['OrderItemVoidAttempt'])

        # Deleting field 'OrderHash.void_tried'
        db.delete_column('localsite_orderhash', 'void_tried')


    def backwards(self, orm):
        
        # Deleting model 'OrderItemVoidAttempt'
        db.delete_table('localsite_orderitemvoidattempt')

        # Adding field 'OrderHash.void_tried'
        db.add_column('localsite_orderhash', 'void_tried', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'49211287a359dfe49a3b758793b4c458'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'})
        },
        'localsite.orderitemvoidattempt': {
            'Meta': {'object_name': 'OrderItemVoidAttempt'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_item': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.OrderItem']", 'unique': 'True'}),
            'void_tried': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'091bedeb80620e34a6fffee6a4c5d1b4'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
