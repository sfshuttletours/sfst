...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('localsite_tourtype_combo_schedules', 'localsite_comboschedule')

        db.add_column('localsite_comboschedule', 'days_after', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # XXX: We went with table rename rather than allowing South to auto-generate the migrations
        # since we added the through='ComboSchedule' in the TourType for field
        # combo_schedules = models.ManyToManyField('TourSchedule'.....)

        # Adding model 'ComboSchedule'
#        db.create_table('localsite_comboschedule', (
#            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
#            ('tourschedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.TourSchedule'])),
#            ('tourtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.TourType'])),
#            ('days_after', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
#        ))
#        db.send_create_signal('localsite', ['ComboSchedule'])
#
...
#        db.delete_table('localsite_tourtype_combo_schedules')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('localsite_comboschedule', 'days_after')
        
        db.rename_table('localsite_comboschedule', 'localsite_tourtype_combo_schedules')

        # Deleting model 'ComboSchedule'
#        db.delete_table('localsite_comboschedule')
#
...
#        db.create_unique('localsite_tourtype_combo_schedules', ['tourtype_id', 'tourschedule_id'])
    ...
    models = {
        ...
        'localsite.comboschedule': {
            'Meta': {'object_name': 'ComboSchedule'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'5789c9319115d74552dd33311a4c8082'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
