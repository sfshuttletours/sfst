...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSkin.hash'
        db.add_column('localsite_siteskin', 'hash', self.gf('common.db_fields.RandomHashField')(default='7c47ac3ea42e9a01c027a5ef0b4b88e3', unique=True, max_length=128, update_on_save=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSkin.hash'
        db.delete_column('localsite_siteskin', 'hash')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'7c47ac3ea42e9a01c027a5ef0b4b88e3'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
