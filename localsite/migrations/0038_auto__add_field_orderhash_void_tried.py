...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'localsite.orderhash': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'c5e9122ad4e1ce5258a2096a66dd470d'", 'unique': 'True', 'max_length': '128', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.Order']", 'unique': 'True'}),
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'d19f49346af947df6e05249fea54216b'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
