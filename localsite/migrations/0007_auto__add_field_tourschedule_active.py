...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourSchedule.active'
        db.add_column('localsite_tourschedule', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TourSchedule.active'
        db.delete_column('localsite_tourschedule', 'active')
