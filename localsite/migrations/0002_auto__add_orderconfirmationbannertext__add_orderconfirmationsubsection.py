...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderConfirmationBannerText'
        db.create_table('localsite_orderconfirmationbannertext', (
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('live', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('banner_image', self.gf('django.db.models.fields.files.ImageField')(max_length=128, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('localsite', ['OrderConfirmationBannerText'])

        # Adding model 'OrderConfirmationSubSection'
        db.create_table('localsite_orderconfirmationsubsection', (
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sub_sections', to=orm['localsite.OrderConfirmationSection'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('live', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('localsite', ['OrderConfirmationSubSection'])

        # Adding model 'OrderConfirmationCoupon'
        db.create_table('localsite_orderconfirmationcoupon', (
            ('coupon_image', self.gf('django.db.models.fields.files.ImageField')(max_length=128)),
            ('live', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('localsite', ['OrderConfirmationCoupon'])

        # Adding model 'OrderConfirmationSection'
        db.create_table('localsite_orderconfirmationsection', (
            ('live', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('localsite', ['OrderConfirmationSection'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'OrderConfirmationBannerText'
        db.delete_table('localsite_orderconfirmationbannertext')

        # Deleting model 'OrderConfirmationSubSection'
        db.delete_table('localsite_orderconfirmationsubsection')

        # Deleting model 'OrderConfirmationCoupon'
        db.delete_table('localsite_orderconfirmationcoupon')

        # Deleting model 'OrderConfirmationSection'
        db.delete_table('localsite_orderconfirmationsection')
    ...
    models = {
        ...
        'localsite.orderconfirmationcoupon': {
            'Meta': {'object_name': 'OrderConfirmationCoupon'},
        ...
        'localsite.orderconfirmationsection': {
            'Meta': {'object_name': 'OrderConfirmationSection'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'live': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'localsite.orderconfirmationsubsection': {
            'Meta': {'object_name': 'OrderConfirmationSubSection'},
