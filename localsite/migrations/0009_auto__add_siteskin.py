...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localsite_siteskin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, db_index=True)),
            ('header_banner_link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('header_banner_image', self.gf('django.db.models.fields.files.ImageField')(max_length=128)),
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=False, unique=True, db_index=True)),
            ('custom_css', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('order_confirmation_logo', self.gf('django.db.models.fields.files.ImageField')(max_length=128)),
            ('order_confirmation_contact_info', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('localsite', ['SiteSkin'])

        # Adding index on 'TourCategory', fields ['active']
        db.create_index('localsite_tourcategory', ['active'])

        # Adding index on 'OrderConfirmationBannerText', fields ['live']
        db.create_index('localsite_orderconfirmationbannertext', ['live'])

        # Adding index on 'OrderConfirmationSubSection', fields ['live']
        db.create_index('localsite_orderconfirmationsubsection', ['live'])

        # Adding index on 'OrderConfirmationSubSection', fields ['order']
        db.create_index('localsite_orderconfirmationsubsection', ['order'])

        # Adding index on 'OrderConfirmationCoupon', fields ['live']
        db.create_index('localsite_orderconfirmationcoupon', ['live'])

        # Adding index on 'OrderConfirmationCoupon', fields ['order']
        db.create_index('localsite_orderconfirmationcoupon', ['order'])

        # Adding index on 'TourSchedule', fields ['active']
        db.create_index('localsite_tourschedule', ['active'])

        # Adding index on 'OrderConfirmationSection', fields ['live']
        db.create_index('localsite_orderconfirmationsection', ['live'])

        # Adding index on 'OrderConfirmationSection', fields ['order']
        db.create_index('localsite_orderconfirmationsection', ['order'])


    def backwards(self, orm):
        
        # Removing index on 'OrderConfirmationSection', fields ['order']
        db.delete_index('localsite_orderconfirmationsection', ['order'])

        # Removing index on 'OrderConfirmationSection', fields ['live']
        db.delete_index('localsite_orderconfirmationsection', ['live'])

        # Removing index on 'TourSchedule', fields ['active']
        db.delete_index('localsite_tourschedule', ['active'])

        # Removing index on 'OrderConfirmationCoupon', fields ['order']
        db.delete_index('localsite_orderconfirmationcoupon', ['order'])

        # Removing index on 'OrderConfirmationCoupon', fields ['live']
        db.delete_index('localsite_orderconfirmationcoupon', ['live'])

        # Removing index on 'OrderConfirmationSubSection', fields ['order']
        db.delete_index('localsite_orderconfirmationsubsection', ['order'])

        # Removing index on 'OrderConfirmationSubSection', fields ['live']
        db.delete_index('localsite_orderconfirmationsubsection', ['live'])

        # Removing index on 'OrderConfirmationBannerText', fields ['live']
        db.delete_index('localsite_orderconfirmationbannertext', ['live'])

        # Removing index on 'TourCategory', fields ['active']
        db.delete_index('localsite_tourcategory', ['active'])

        # Deleting model 'SiteSkin'
        db.delete_table('localsite_siteskin')
