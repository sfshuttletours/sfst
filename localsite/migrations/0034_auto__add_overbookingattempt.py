...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OverbookingAttempt'
        db.create_table('localsite_overbookingattempt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tour', self.gf('django.db.models.fields.related.ForeignKey')(related_name='overbookings', to=orm['localsite.TourProduct'])),
            ('occurred_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('localsite', ['OverbookingAttempt'])


    def backwards(self, orm):
        
        # Deleting model 'OverbookingAttempt'
        db.delete_table('localsite_overbookingattempt')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'76e06daa898d81bbfce653e3e405fc56'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
