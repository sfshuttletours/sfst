...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TourGuest'
        db.create_table('localsite_tourguest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('order_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.OrderItem'])),
        ))
        db.send_create_signal('localsite', ['TourGuest'])


    def backwards(self, orm):
        
        # Deleting model 'TourGuest'
        db.delete_table('localsite_tourguest')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'37470b85206c92aff438eb275c87afe9'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
