...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteSkin.is_concierge_cta'
        db.add_column('localsite_siteskin', 'is_concierge_cta', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'SiteSkin.reseller_lp_content'
        db.add_column('localsite_siteskin', 'reseller_lp_content', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteSkin.is_concierge_cta'
        db.delete_column('localsite_siteskin', 'is_concierge_cta')

        # Deleting field 'SiteSkin.reseller_lp_content'
        db.delete_column('localsite_siteskin', 'reseller_lp_content')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'ddb0ca993f4d13dc248d82585d3fc366'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
