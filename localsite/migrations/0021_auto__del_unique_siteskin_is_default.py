...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SiteSkin', fields ['is_default']
        db.delete_unique('localsite_siteskin', ['is_default'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'SiteSkin', fields ['is_default']
        db.create_unique('localsite_siteskin', ['is_default'])
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'0de3ee1fb30e8ff22a8e2a3eb1ce87eb'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
