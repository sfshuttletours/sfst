...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderCompletedSiteSkin'
        db.create_table('localsite_ordercompletedsiteskin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Order'], unique=True)),
            ('site_skin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.SiteSkin'])),
        ))
        db.send_create_signal('localsite', ['OrderCompletedSiteSkin'])


    def backwards(self, orm):
        
        # Deleting model 'OrderCompletedSiteSkin'
        db.delete_table('localsite_ordercompletedsiteskin')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'90acf1b769b5512e428b895720974187'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
