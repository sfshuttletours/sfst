...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CartGuest'
        db.create_table('localsite_cartguest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('cart_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.CartItem'])),
        ))
        db.send_create_signal('localsite', ['CartGuest'])


    def backwards(self, orm):
        
        # Deleting model 'CartGuest'
        db.delete_table('localsite_cartguest')
    ...
    models = {
        ...
        'localsite.siteskin': {
            ...
            'hash': ('common.db_fields.RandomHashField', [], {'default': "'c2f836db6fd1be80c2559186c838f0a2'", 'unique': 'True', 'max_length': '128', 'update_on_save': 'True', 'db_index': 'True'}),
