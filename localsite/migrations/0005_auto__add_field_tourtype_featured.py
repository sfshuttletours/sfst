...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TourType.featured'
        db.add_column('localsite_tourtype', 'featured', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TourType.featured'
        db.delete_column('localsite_tourtype', 'featured')
