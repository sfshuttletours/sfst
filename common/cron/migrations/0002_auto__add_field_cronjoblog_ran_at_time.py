...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cron_cronjoblog', 'ran_at_time', self.gf('django.db.models.fields.TimeField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CronJobLog.ran_at_time'
        db.delete_column('cron_cronjoblog', 'ran_at_time')
