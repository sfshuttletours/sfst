...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('adjustments_adjustment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.OrderItem'], unique=True)),
        ))
        db.send_create_signal('adjustments', ['Adjustment'])

        # Adding model 'AdjustmentHistory'
        db.create_table('adjustments_adjustmenthistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('adjustment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='history', to=orm['adjustments.Adjustment'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('from_status', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('to_status', self.gf('django.db.models.fields.IntegerField')()),
            ('notes', self.gf('django.db.models.fields.TextField')()),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('adjustments', ['AdjustmentHistory'])


    def backwards(self, orm):
        
        # Deleting model 'Adjustment'
        db.delete_table('adjustments_adjustment')

        # Deleting model 'AdjustmentHistory'
        db.delete_table('adjustments_adjustmenthistory')
    ...
    models = {
        'adjustments.adjustment': {
            ...
            'item': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['shop.OrderItem']", 'unique': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {})
        },
        'adjustments.adjustmenthistory': {
            'Meta': {'object_name': 'AdjustmentHistory'},
            'adjustment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'history'", 'to': "orm['adjustments.Adjustment']"}),
            'from_status': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'to_status': ('django.db.models.fields.IntegerField', [], {}),
